...
Key Features implemented:
  1. Resume text cleaning & parsing
  2. Skill extraction & matching with job descriptions
  3. Candidate ranking based on role fit
  4. Skill gap identification

Deliverable: A resume screening system that ranks candidates and
